						...
						<tr>
							...
							<c:if test="${board.depth == 0}">
								<td style="text-align: left; padding-left: ${board.depth *20}px"><a
									href="${pageContext.servletContext.contextPath }/board?a=view&no=${board.no}">${board.title }</a></td>
							</c:if>
							...
							<td><c:choose>
									<c:when test="${board.userName eq authUser.name }">
										<a
											href="${pageContext.servletContext.contextPath }/board?a=delete&no=${board.no}"><img
