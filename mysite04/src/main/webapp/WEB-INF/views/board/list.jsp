				...
				<div class="pager">
					<ul>
						<c:choose>
							...
							<c:otherwise>
								<li><a href="${pageContext.servletContext.contextPath }/board/${map.firstPageNo - 10}">◀</a></li>
							</c:otherwise>
						...
						<c:forEach var="pageNo" begin="${map.firstPageNo }"	end="${map.lastPageNo }">
							<c:choose>
								...
								<c:otherwise>
									<li><a href="${pageContext.servletContext.contextPath }/board/${pageNo }">${pageNo }</a></li>
								</c:otherwise>
							</c:choose>
						</c:forEach>
						<c:choose>
