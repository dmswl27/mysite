...
public class SecurityConfig extends WebMvcConfigurerAdapter {
	 ...
	 * path="/user/auth" /> <mvc:exclude-mapping path="/user/logout" />
	 * <mvc:exclude-mapping path="/assets/**" /> <bean
	 * class="com.douzone.mysite.security.AuthInterceptor" /> </mvc:interceptor>
	 * </mvc:interceptors>
	 * 
	 * 
	 */
