...
public class BoardController {
	...
	@RequestMapping("/{page}")
	public String list(@PathVariable("page") String pageNum, Model model) {
		int page;
	...
	public String write(@RequestParam(value = "title") String title, @RequestParam(value = "contents") String contents,
			@AuthUser UserVo authUser, BoardVo vo) {
		vo.setTitle(title);
	...
	public String comment(@PathVariable("no") Long no, @RequestParam(value = "title", required=true, defaultValue="") String title,
	...
	public String modify(BoardVo vo, Model model, @AuthUser UserVo authUser) {
		vo.setUserNo(authUser.getNo());
